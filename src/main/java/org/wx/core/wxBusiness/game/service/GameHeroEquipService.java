...
public class GameHeroEquipService extends WxServiceImpl<GameHeroEquipMapper, GameHeroEquip> {
    ...
    private void persistSlotItemId(GameHeroEquip equip, HeroEquipSlot slot, String itemId) {
        ...
        switch (slot) {
            ...
            case SKILL_BADGE_1 -> wrapper.set(GameHeroEquip::getSkillBadge1ItemId, itemId);
            case SKILL_BADGE_2 -> wrapper.set(GameHeroEquip::getSkillBadge2ItemId, itemId);
            case SKILL_BADGE_3 -> wrapper.set(GameHeroEquip::getSkillBadge3ItemId, itemId);
            case SKILL_BADGE_4 -> wrapper.set(GameHeroEquip::getSkillBadge4ItemId, itemId);
        }
        this.update(wrapper);
    }
