...
public class CarryWeightService {
    ...
    public BattleBagVo buildWeightSummary(GameHero hero, List<GameBattleBag> bagRows, List<GameItem> items,
        ...
        if (combat != null && combat.getPassiveActionValueFactor() != null
                && combat.getPassiveActionValueFactor().compareTo(BigDecimal.ONE) != 0) {
            effectiveAction = BigDecimal.valueOf(effectiveAction)
                    .multiply(combat.getPassiveActionValueFactor())
